...
def google_cookie_consent(driver, accept=False):
    try:
        reject_button = driver.find_elements_by_class_name("Nc7WLe")[0]
        accept_button = driver.find_elements_by_class_name("Nc7WLe")[1]
